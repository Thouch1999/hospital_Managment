            <div class="content">
              <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                  <a href="index.php?p_employee=add_employee" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Employee</a>
                </div>
              </div>
                          ...
                          <td class="text-right">
                            <div class="dropdown dropdown-action">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="index.php?p_employee=update_empolyee"><i class="fa fa-pencil m-r-5"></i> Edit</a>
