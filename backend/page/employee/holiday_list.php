            <div class="content">
              <div class="row">
                ...
                <div class="col-sm-7 col-7 text-right m-b-30">
                  <a href="index.php?p_employee=add_holiday" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add Holiday</a>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                          ...
                          <td class="text-right">
                            <div class="dropdown dropdown-action">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="index.php?p_employee=edit_holiday"><i class="fa fa-pencil m-r-5"></i> Edit</a>
