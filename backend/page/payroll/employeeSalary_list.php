            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-7 text-right m-b-30">
                        <a href="index.php?p_payroll=add_employeeSalary" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Salary</a>
                    </div>
                </div>
                            ...
                            <table class="table table-striped custom-table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$59698</td>
                                        <td><a class="btn btn-sm btn-primary" href="index.php?p_payroll=payslip_view">Generate Slip</a></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="index.php?p_payroll=edit_employeeSalary"><i class="fa fa-pencil m-r-5"></i> Edit</a>
