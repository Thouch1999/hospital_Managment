            <div class="content">
              <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                  <a href="index.php?p_doctor_sch=add_doctor_sch" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Schedule</a>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                          ...
                          <td class="text-right">
                            <div class="dropdown dropdown-action">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="index.php?p_doctor_sch=update_doctor_sch"><i class="fa fa-pencil m-r-5"></i> Edit</a>
