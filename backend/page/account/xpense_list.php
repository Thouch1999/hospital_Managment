<div class="content">
  <div class="row">
    ...
    <div class="col-sm-4 col-7 text-right m-b-30">
      <a href="index.php?p_account=add_xpense" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Expense</a>
    </div>
  </div>
            ...
            <tr>
              ...
              <td class="text-right">
                <div class="dropdown dropdown-action">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="index.php?p_account=edit_xpense"><i class="fa fa-pencil m-r-5"></i> Edit</a>
