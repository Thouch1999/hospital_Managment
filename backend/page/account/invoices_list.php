<div class="content">
  <div class="row">
    ...
    <div class="col-sm-7 col-8 text-right m-b-30">
      <a href="index.php?p_account=add_invoice" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Create New Invoice</a>
    </div>
  </div>
              ...
              <td class="text-right">
                <div class="dropdown dropdown-action">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="index.php?p_account=edit_invoice"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                    <a class="dropdown-item" href="index.php?p_account=invoice_view"><i class="fa fa-eye m-r-5"></i> View</a>
